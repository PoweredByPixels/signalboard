...
function move(id){ const job=jobs.find(j=>j.id===id), at=columns.indexOf(job.status); if(at<columns.length-1){setStatus(job,columns[at+1]);save();render();} }
